...
const SearchBar = ({toggleSideBar, displaySideBar}) => {
  return (
    <div className={styles.container}>
        <div className={styles.menu}>
            <div className={styles.burger} onClick={() => toggleSideBar(!displaySideBar)}>
        ...
        <div className={styles.search}>
            ...
            <div className={styles.mic}>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="white" className="bi bi-mic-fill" viewBox="0 0 16 16">
        ...
        <div className={styles.profile}>
            <div className={styles.camera}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-camera-video" viewBox="0 0 16 16">
