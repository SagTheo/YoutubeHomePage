  ...
  return (
    <div className={styles.container}>
        <div className={styles.menu}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" className="bi bi-youtube" viewBox="0 0 16 16">
        ...
        <div className={styles.search}>
            ...
            <div className={styles.mic}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-mic-fill" viewBox="0 0 16 16">
        ...
        <div className={styles.profile}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-camera-video" viewBox="0 0 16 16">
